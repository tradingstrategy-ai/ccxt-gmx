...
export default class gmx extends Exchange {
    ...
    async fetchOpenInterests (symbols: Strings = undefined, params = {}): Promise<any> {
    ...
    async fetchFundingRateHistory (symbol: string, since: Int = undefined, limit: Int = undefined, params = {}): Promise<any> {
        return await this.requestBridge ('fetchFundingRateHistory', [ symbol, since, limit ], { 'params': params });
    }

    async fetchFundingHistory (symbol: string = undefined, since: Int = undefined, limit: Int = undefined, params = {}): Promise<any> {
        return await this.requestBridge ('fetchFundingHistory', [ symbol, since, limit ], { 'params': params });
    }

    async fetchAPY (symbols: Strings = undefined, params = {}): Promise<any> {
    ...
    async fetchLeverageTiers (symbols: Strings = undefined, params = {}): Promise<any> {
    ...
    async cancelOrders (ids: Strings = undefined, symbol: Str = undefined, params = {}) {
